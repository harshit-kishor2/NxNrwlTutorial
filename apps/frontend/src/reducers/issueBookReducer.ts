import { ISSUE_BOOK_BYID_FAIL, ISSUE_BOOK_BYID_REQUEST, ISSUE_BOOK_BYID_SUCCESS, ISSUE_BOOK_FAIL, ISSUE_BOOK_REQUEST, ISSUE_BOOK_SUCCESS } from '../constants/issueBookConstatnst';
