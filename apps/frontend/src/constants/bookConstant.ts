...
export const DETAIL_BOOK_REQUEST = 'DETAIL_BOOK_REQUEST'
export const DETAIL_BOOK_SUCCESS = 'DETAIL_BOOK_SUCCESS'
export const DETAIL_BOOK_FAIL = 'DETAIL_BOOK_FAIL'